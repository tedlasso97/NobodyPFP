...
client_v1 = get_twitter_conn_v1()  # For posting replies
client_v2 = get_twitter_conn_v2()  # For fetching mentions
...
if __name__ == '__main__':
    ...
    scheduler.add_job(serve_job, 'interval', seconds=45)  # Serve replies safely
